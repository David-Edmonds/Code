/* Our Table: pure, dependency-free recipe and backup helpers. */
(function(root) {
  'use strict';
  const unicode = {'½':'1/2','¼':'1/4','¾':'3/4','⅓':'1/3','⅔':'2/3','⅛':'1/8','⅜':'3/8','⅝':'5/8','⅞':'7/8'};
  ...
  function fmt(n) {
    ...
    const fractions=[[.125,'⅛'],[.25,'¼'],[1/3,'⅓'],[.375,'⅜'],[.5,'½'],[.625,'⅝'],[2/3,'⅔'],[.75,'¾'],[.875,'⅞']];
  ...
  function parseBackup(text) {
    ...
    if(data.app!=='Our Table'||data.schema!==1||!Array.isArray(data.recipes)||data.recipes.length>500)throw Error('Choose an Our Table version 1 backup.');
